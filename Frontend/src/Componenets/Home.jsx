    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between min-h-screen p-6 bg-gray-100 pt-16">
                ...
                <div className="md:w-4/5  text-center ml-16 md:text-left">
                    ...
                    <div className="mt-12 flex justify-center md:justify-start gap-4">        
                        <button
                            className="px-6 py-2 rounded-lg text-white text-xl shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl hover:cursor-pointer"
                            style={{ backgroundColor: "#dfc634" }}
                            onClick={() => navigate("/register")}
                        >
                            Register
                        </button>     
                        <button className="px-6 py-2 bg-white text-gray-800 text-xl border border-gray-300 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl hover:cursor-pointer"
